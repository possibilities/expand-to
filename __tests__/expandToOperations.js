  ...
  describe('basic', () => {
    ...
    test('response', () => {
      expect(
        ...
        { code: 200, description: 'List succeeded', key: 'pets', schema: 'pet' },
        ...
        { code: 200, description: 'List succeeded', key: 'stores', schema: 'store' },
        ...
        { code: 204, description: 'Delete succeeded', schema: 'empty' },
        { code: 200, description: 'List succeeded', key: 'managers', schema: 'manager' },
